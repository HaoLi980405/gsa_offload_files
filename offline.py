...
def main():
    ...
    with build_llm_with_uc(module_path, name, model) as llm:
        ...
        print_output(llm, [f"文档{i}:\n"+prompts[0] for i in range(10)], sampling_params, "first")
